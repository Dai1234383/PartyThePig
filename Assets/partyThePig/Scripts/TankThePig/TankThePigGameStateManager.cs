...
public class TankThePigGameStateManager : MonoBehaviour
{
    public static TankThePigGameStateManager Instance;
    ...
    {
        TankThePigUIManager.Instance.GameOverUI(winnerName);
