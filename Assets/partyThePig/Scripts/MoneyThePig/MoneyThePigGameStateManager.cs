...
public class MoneyThePigGameStateManager : MonoBehaviour
{
    public static MoneyThePigGameStateManager Instance;
    ...
    private async UniTaskVoid TimerStart()
    {
        ...
        {
            if(MoneyThePigScoreManager.Instance.Player1Score> MoneyThePigScoreManager.Instance.Player2Score)
            {
                GameOver("Player1");
            }
            else if(MoneyThePigScoreManager.Instance.Player1Score < MoneyThePigScoreManager.Instance.Player2Score)
            {
                GameOver("Player2");
            }
            else
